...
- les codes stagiaire, stage et projet sont générés automatiquement et de manière
  transactionnelle aux formats `STG-AAAA-NNNN`, `STAGE-AAAA-NNNN` et
  `PRJ-AAAA-NNNN`, puis restent immuables ;
